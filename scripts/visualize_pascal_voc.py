...
def visualize(args):
    ...
    predict_on_random_pascal_voc_images(
        model, mini_val_dataset, n=5, seed=4)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_signature", type=str,
                        help="The path to the checkpoint in the format RUN_ID:CHECKPOINT_PATH eg: IM-28:checkpoints/epoch_5", required=False)

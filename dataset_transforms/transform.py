...
OUTPUT_DIRECTORY = "/Users/rishimalhotra/projects/cv/image_classification/image_net_data_resized"
...
def resize_image(image_path):
    ...
    output_dir = os.path.join(OUTPUT_DIRECTORY, os.path.relpath(
        base_path, start=IMAGE_DIRECTORY))
